                                ...
                                <div className="col-md-8 col-sm-12 text-box-container">
                                    <div className="text-box">
                                        <div className="description">
                                            ...
                                            <blockquote>
                                                <p className="lead">Founder, President & CEO</p>
                                                    <p className="strengths">Positivity | Achiever | Arranger | Responsibility | Input</p>
                                            </blockquote>

                                                <p>Gabriela established PPR in February of 2010, following a dream to build a firm that could positively influence work environments. Since securing PPR’s first client, Gabriela insisted in going above and beyond for client needs, something that opened other doors. To this date, PPR has grown 100% as a result of referrals. Gabriela has thoughtfully selected a group of talented experts who compliment her, surrounding herself with outstanding and passionate professionals that now form a well-rounded team in all facets of human resources. PPR’s bar is unapologetically high, and under Gabriela’s leadership, her team has consistently delivered with excellence in all they do, partnering with clients to create excellent workplaces.</p>

                                                <p>Gabriela's areas of focus include operational leadership, executive and board level decision making, bilingual/bicultural expertise, board governance support, CEO succession planning, human capital analysis, executive coaching, re-inventing performance management methodologies, executive compensation, diversity - equity - inclusion - belonging, strategic planning and development, change management, employment compliance, organizational enhancement, executive searches, and more.</p>
