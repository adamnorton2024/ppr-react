                  ...
                  <div className="col-lg-7 col-md-12 my-5">
                    <div className="text-box">
                      ...
                      <div className="description">
                        <p className="lead">
                          People Performance Resources, LLC (PPR) was designed
                        ...
                        <p className="lead">
                          When we become your strategic HR business partner, you
                          will receive a high level of personal commitment and
                          dedication that is Best-in-Class. For each project, we
                          will become an extension of your organization to show
                          a unified vision to all employees. We also provide a
                          true ROI as every dollar you spend goes towards
                          developing and receiving best practices, and there is
                          never down-time.
                        </p>
                      </div>
                    </div>
